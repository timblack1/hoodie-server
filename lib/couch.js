...
/**
 * Returns couchdb session info for http request object
 */

exports.getUserCtx = function (config, req, callback) {
  var opt = {
    url: url.resolve(config.couch.url, '_session'),
    headers: {
