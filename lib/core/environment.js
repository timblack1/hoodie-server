...
exports.getConfig = function (platform, env, project_dir, argv) {
  ...
  var getAdminRoot = function() {
    var appContextPath = project_dir + '/node_modules/hoodie-server/node_modules/hoodie-pocket/www';
    var standaloneContextPath = project_dir + '/node_modules/hoodie-pocket/www';
    if (fs.existsSync(standaloneContextPath)) {
      return standaloneContextPath;
    }
